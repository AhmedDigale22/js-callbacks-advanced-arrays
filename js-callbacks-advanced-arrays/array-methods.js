...
const ticketPriceTotal = runners.reduce((total, runners) => {
...
const LowestDonation = runners.filter((runner) => runner.donation < 15);
console.log(" donation that is less than 15:", LowestDonation);

// Problem 2 with solution.
const highDonationRunners = runners.filter((runner) => runner.donation > 200);
console.log("Runners with high donations:", highDonationRunners);
// Problem 3 with solution.
const totalDonation = runners.reduce((sum, runner) => sum + runner.donation, 0);
const averageDonation = totalDonation / runners.length;
console.log("Average donation amount per runner:", averageDonation);
